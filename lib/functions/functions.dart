  ...
  try {
    ...
    if (mapType == 'google') {
      ...
      for (var element in result.predictions) {
        var val =
            await geoCodingForLatLng(element.fullText, element.secondaryText);
        if (val != null) {
          addAutoFill.add({
...
// primaryText: Gandhipuram Bus stand to SRP mill, Saravananpatty, secondaryText: Bharathiyar Road, ATT Colony, Gopalapuram, New Siddhapudur, Tamil Nadu, India, fullText: Gandhipuram Bus stand to SRP mill, Saravananpatty, Bharathiyar Road, ATT Colony, Gopalapuram, New Siddhapudur, Tamil Nadu, India),
